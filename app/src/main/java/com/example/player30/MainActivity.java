...
public class MainActivity extends AppCompatActivity implements Runnable{
    ...
    String song = "Девочка бандитка.mp3";
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case  R.id.fabNext:
                    ...
                    if (song == "Pyrokinesis.mp3" ) {
                        song = "Девочка бандитка.mp3";
                        playSong();
                        break;
                    }
                    if (song == "Девочка бандитка.mp3" ){
                        song = "Ягода малина.mp3";
                        playSong();
                        break;
                    }
                    if (song == "Ягода малина.mp3" ){
                        song = "Pyrokinesis.mp3";
                        playSong();
                        break;
                    }
    ...
    public void playSong() {
        try { // обработка исключения на случай отстутствия файла
            ...
            if (!wasPlaying) {
                ...
                AssetFileDescriptor descriptor = getAssets().openFd(song);
